...
exact_id_matches = []
canonical_only_matches = []   # the interesting bucket: caught ONLY by canonical link, not exact id
new_jobs = []

seen_canonical_this_run = set()  # catches same-run dupes between the two sources themselves
...
print("\n--- sample of canonical-only matches (this is the cross-source dedup in action) ---")
